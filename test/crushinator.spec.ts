...
describe("crushinator", () => {
  ...
  describe("crush", () => {
    ...
    test("should return the original URL for images hosted outside the whitelist", () => {
      ...
      expect(
        crushinator.crush("https://avatars.ted.com/v1/avatar/1350407280.svg")
      ).toEqual("https://avatars.ted.com/v1/avatar/1350407280.svg");
    });
    ...
    test("should percent-encode known problematic characters", () => {
      ...
      expect(crushinator.crush(url)).toEqual(
        "https://pi.tedcdn.com/r/images.ted.com/Joe%27s %22air quotes%22 %281%29.jpg"
      );
    });
